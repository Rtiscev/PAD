package com.example.ms_yt_dlp.service;
...
public class FileService {
    ...
    public String addSimpleFile(String Url) {
        //define additional metadata
        DBObject metadata = new BasicDBObject();
        ...
        try (InputStream inputStream = new FileInputStream(file)) {
            ...
            //store in database which returns the objectID
            Object fileID = template.store(inputStream, file.getName(), Files.probeContentType(file.toPath()), metadata);
